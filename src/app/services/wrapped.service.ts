...
export class WrappedService {
  ...
  private getMockData(userId: string, year: number): WrappedData {
    return {
      ...
      monthlyBreakdown: [
        {month: 'Jan', posts: 8}, {month: 'Feb', posts: 11},
        {month: 'Mar', posts: 14}, {month: 'Apr', posts: 18},
        {month: 'May', posts: 15}, {month: 'Jun', posts: 13},
        {month: 'Jul', posts: 10}, {month: 'Aug', posts: 12},
        {month: 'Sep', posts: 14}, {month: 'Oct', posts: 11},
        {month: 'Nov', posts: 10}, {month: 'Dec', posts: 11}
      ],
      ...
      topAO: {name: 'Bleach', posts: 52, percentage: 35},
      ...
      qStats: {timesAsQ: 11, totalPaxLed: 187, averagePaxPerQ: 17}
    };
  }
}